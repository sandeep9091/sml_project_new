...
class LoanApprovalsPageViewModel extends BasePageViewModel {
  ...
  ValueNotifier<String> selectedLoanStatus = ValueNotifier("");
  ...
  TextEditingController controllerLoanStatusRemarks = TextEditingController();
  ...
  LoanApprovalsPageViewModel(this._generateLoansUseCase,this._commonUseCase,this._borrowersUseCase) {
        ...
        secure: 
          {
            ...
            "approvalstatus": selectedLoanStatus.value,
            "approvalremarks": controllerLoanStatusRemarks.text,
            "approvalby": "P",
            "active": true,
  ...
  controllerLoanStatusRemarks.clear();
  }
