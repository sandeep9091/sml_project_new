...
class GenerateLoansPageView extends BasePageViewWidget<GenerateLoansPageViewModel> {
    const GenerateLoansPageView(ProviderBase model, {Key? key}) : super(model, key: key);
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          CommonTitleValueWidget(title: "Approval",value: CommonLists.getUserName(context,eachGeneratedLoan.createBy),width: MediaQuery.of(context).size.width *.70,),
                          ApproveStatusWidget(status: eachGeneratedLoan.approvalstatus),
                        ],
                      ),
                      CommonTitleValueWidget(title: "Remarks",value: eachGeneratedLoan.approvalremarks,),
                    ],
                  )
                  );
                });
